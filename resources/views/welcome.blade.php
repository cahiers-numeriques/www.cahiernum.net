				...
				<div class="row row-cols-1 row-cols-md-2 g-2">
					...
					<div class="col">
						<div class="card h-100 p-2">
							<div class="text-danger fw-bolder font-monospace ps-2">Coder un jeu avec Scratch</div>
							<ul>
								<li class="mt-2">
					...
					<div class="col">
						<div class="card h-100 p-2">
							<div class="text-danger fw-bolder font-monospace ps-2">Tutoriels GeoGebra</div>
							<ul>
								<li class="mt-2">
